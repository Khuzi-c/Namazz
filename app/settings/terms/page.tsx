                        ...
                        <div className="p-4 flex items-center justify-between border-t border-gray-50 dark:border-emerald-800">
                            ...
                            <button
                                onClick={() => {
                                    ...
                                    localStorage.setItem('beta-ads-enabled', newValue ? 'true' : 'false')

                                    // Native AdMob Logic (Median)
                                    if (typeof window !== 'undefined' && (window as any).median?.admob) {
                                        if (newValue) (window as any).median.admob.banner.enable();
                                        else (window as any).median.admob.banner.disable();
                                    }
